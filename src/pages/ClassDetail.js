...
export default function ClassDetail() {
    ...
    const handleSubmit = (event)=>{
        ...
        axios.put(`http://localhost/timetofill/class.php/${id}`, JSON.stringify(classData))
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col">
        ...
        <form className="flex justify-center mb-12" onSubmit={handleSubmit} >
        ...
        <div className= "w-full flex items-center justify-center mt-8 mb-2 px-4 tracking-widest text-[#f8fafc]">
            <button type="submit" className="w-28 h-8 rounded bg-[#577BC1] mr-6 ">Save</button>
            <button type="button" onClick={backToClassPage} className="w-32 h-8 rounded bg-[#577BC1] ">Back</button>
        </div>
        </div >
        </form>
      </div>
