  ...
  return (
    <div className="flex justify-between h-16 w-screen bg-[#577BC1]">
      ...
      <div className="hidden lg:flex items-center gap-x-4 py-1 mr-8 justify-end">
        ...
        <Link to="/profile" className="w-28 h-8 py-2 text-sm align-middle text-center rounded hover:bg-blue-300 text-[#f8fafc] tracking-widest hover:bg-blue-700 hover:text-indigo-950">Profile</Link>
